...
public class CreateContact {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		objcrmdriver.findElement(By.xpath("//input[@id='firstNameField']")).sendKeys("mojo");
		objcrmdriver.findElement(By.xpath("//input[@id='lastNameField']")).sendKeys("takko");
		objcrmdriver.findElement(By.xpath("//input[@name='departmentName']")).sendKeys("EEE");
		objcrmdriver.findElement(By.xpath("//textarea[@id='createContactForm_description']")).sendKeys("Create contact info");
		objcrmdriver.findElement(By.xpath("//input[@id='createContactForm_primaryEmail']")).sendKeys("saranneyveli@gmail.com");
